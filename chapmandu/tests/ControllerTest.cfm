<cfcomponent extends="wheelsMapping.Test">
    ...
    <cffunction name="setup">
        ...
        <cfset loc.controller = "[NamePluralUppercase]">
        <cfset loc.id = 1>
        <cfset loc.name = "[NamePluralUppercase] Name">
    </cffunction>
    ...
    <cffunction name="test_index_displays_[NameSingularLowercase]_listing">
        ...
        <cfset loc.response = controllerActionResponse(controller=loc.controller, action="index", params=loc.params)>
    ...
    <cffunction name="test_show_displays_[NameSingularLowercase]">
        ...
        <cfset loc.params = {key=loc.id}>
        <cfset loc.response = controllerActionResponse(controller=loc.controller, action="show", params=loc.params)>
        <cfset loc.string = '<h2>#loc.name#</h2>'>
        <cfset assert('loc.response contains loc.string')>
        <cfset assertLayoutExists(loc.response)>
    </cffunction>
    ...
    <cffunction name="test_show_redirects_to_index_if_a_[NameSingularLowercase]_is_not_found">
        ...
        <cfset loc.redirect = controllerActionRedirect(controller=loc.controller, action="show", params=loc.params)>
    ...
    <cffunction name="test_new_displays_[NameSingularLowercase]_form">
        ...
        <cfset loc.response = controllerActionResponse(controller=loc.controller, action="new", params=loc.params)>
    ...
    <cffunction name="test_edit_displays_[NameSingularLowercase]_form">
        <cfset loc.params = {key=loc.id}>
        <cfset loc.response = controllerActionResponse(controller=loc.controller, action="edit", params=loc.params)>
        <cfset loc.string = '<h2>Edit [NameSingularUppercase] - #loc.name#</h2>'>
        <cfset assert('loc.response contains loc.string')>
        <cfset assertLayoutExists(loc.response)>
    </cffunction>
    ...
    <cffunction name="test_edit_redirects_to_index_if_a_[NameSingularLowercase]_is_not_found">
        <cfset loc.params = {key=-1}>
        <cfset loc.redirect = controllerActionRedirect(controller=loc.controller, action="edit", params=loc.params)>
        <cfset assert('StructKeyExists(loc.redirect, "$args")')>
        <cfset assert('loc.redirect.$args.action eq "index"')>
    </cffunction>
    ...
    <cffunction name="test_create_redirects_to_index_after_a_[NameSingularLowercase]_is_created">
        ...
        <cfset loc.redirect = controllerActionRedirect(controller=loc.controller, action="create", params=loc.params)>
        <cfset assert('StructKeyExists(loc.redirect, "$args")')>
        <cfset assert('loc.redirect.$args.action eq "index"')>
    </cffunction>
    ...
    <cffunction name="test_create_errors_display_when_[NameSingularLowercase]_is_invalid">
        ...
        <cfset loc.response = controllerActionResponse(controller=loc.controller, action="create", params=loc.params)>
    ...
    <cffunction name="test_update_redirects_to_index_after_a_[NameSingularLowercase]_is_updated">
        <cfset loc.params = {key=loc.id}>
        <cfset loc.params.[NameSingularLowercase] = loc.validProperties>
        <cfset loc.redirect = controllerActionRedirect(controller=loc.controller, action="update", params=loc.params)>
        <cfset assert('StructKeyExists(loc.redirect, "$args")')>
        <cfset assert('loc.redirect.$args.action eq "index"')>
    </cffunction>
    ...
    <cffunction name="test_update_errors_display_when_[NameSingularLowercase]_is_invalid">
        <cfset loc.params = {key=loc.id}>
        <cfset loc.params.[NameSingularLowercase] = loc.invalidProperties>
        <cfset loc.response = controllerActionResponse(controller=loc.controller, action="update", params=loc.params)>
    ...
    <cffunction name="test_delete_redirects_to_index_after_a_[NameSingularLowercase]_is_deleted">
        <cfset loc.params = {key=loc.id}>
        <cfset loc.redirect = controllerActionRedirect(controller=loc.controller, action="delete", params=loc.params)>
        <cfset assert('StructKeyExists(loc.redirect, "$args")')>
        <cfset assert('loc.redirect.$args.action eq "index"')>
    </cffunction>
